...
- [2、面试官心里分析](#2面试官心里分析)
- [3、面试题剖析](#3面试题剖析)
    - [（1）如何实现mysql的读写分离？](#1如何实现mysql的读写分离)
    - [（2）MySQL主从复制原理的是啥？](#2mysql主从复制原理的是啥)
    - [（3）mysql主从同步延时问题（精华）](#3mysql主从同步延时问题精华)
...
![01_为什么MySQL要读写分离？](../../pic/2019-06-12-09-31-59.png)

![02_MySQL主从复制原理](../../pic/2019-06-12-09-32-21.png)

![03_MySQL主从延迟导致的生产环境的问题](../../pic/2019-06-12-09-32-49.png)