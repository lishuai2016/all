...
import com.ls.netty.rpc.client.ConnectManage;
import com.ls.netty.rpc.client.RPCFuture;
import com.ls.netty.rpc.client.RpcClientHandler;
 ...
 */
public class ClientProxy<T> implements InvocationHandler, IAsyncClientProxy {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        RPCFuture rpcFuture = handler.sendRequest(request); //具体的发送请求消息
