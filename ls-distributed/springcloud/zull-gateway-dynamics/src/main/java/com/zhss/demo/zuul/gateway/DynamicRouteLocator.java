...
public class DynamicRouteLocator extends SimpleRouteLocator implements RefreshableRouteLocator {
    ...
    /**
     * org.springframework.cloud.netflix.zuul.filters.SimpleRouteLocator#doRefresh()
     * 调用org.springframework.cloud.netflix.zuul.filters.SimpleRouteLocator#locateRoutes()
     *
     *  这里通过重写locateRoutes()来实现自定义加载路由信息
     */
    @Override
    public void refresh() {
        doRefresh();
