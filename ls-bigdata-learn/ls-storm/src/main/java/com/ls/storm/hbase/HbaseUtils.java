...
public class HbaseUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		//创建一张表
		hbase.createTable("WordCount","cf");
//		//查询所有表名
//		 hbase.getALLTable();

//		//往表中添加一条记录
//		hbase.put(hbase.TABLE_NAME, "1", hbase.COLUMNFAMILY_1, hbase.COLUMNFAMILY_1_AUTHOR, "sxt");
//		hbase.put(hbase.TABLE_NAME, "1", hbase.COLUMNFAMILY_1, hbase.COLUMNFAMILY_1_CONTENT, "你好");
//		hbase.put(hbase.TABLE_NAME, "1", hbase.COLUMNFAMILY_1, hbase.COLUMNFAMILY_1_DESCRIBE, "66666");
//		hbase.put(hbase.TABLE_NAME, "1", hbase.COLUMNFAMILY_1, hbase.COLUMNFAMILY_1_TITLE, "贴图视图视图");
		//查询一条记录
//		Doc doc = hbase.get("doc","1");
