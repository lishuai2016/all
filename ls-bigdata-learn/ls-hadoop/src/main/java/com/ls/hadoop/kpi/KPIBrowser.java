...
public class KPIBrowser {
    static class KPIBrowserMapper extends Mapper<Object, Text, Text, IntWritable> {
    ...
    static class KPIBrowserReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileOutputFormat.setOutputPath(job, new Path(
                "hdfs://192.168.137.127:9000/output/KPIBrowser"));
